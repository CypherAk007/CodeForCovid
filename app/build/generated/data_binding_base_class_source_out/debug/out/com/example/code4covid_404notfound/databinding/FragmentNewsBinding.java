...
public final class FragmentNewsBinding implements ViewBinding {
  ...
  private FragmentNewsBinding(@NonNull LinearLayout rootView, @NonNull Button btnSearch,
      @NonNull EditText etQuery, @NonNull RecyclerView newsList) {
  ...
  public static FragmentNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.newsList;
      RecyclerView newsList = rootView.findViewById(id);
      if (newsList == null) {
        break missingId;
      }

      return new FragmentNewsBinding((LinearLayout) rootView, btnSearch, etQuery, newsList);
    }
